<main class="container mx-auto py-12">
    ...
    <?php if (empty($articles)): ?>
        <div class="text-center mt-16">
            <p class="text-gray-600 mt-2">It looks like you haven’t marked any articles as favorites yet. Start exploring and add some!</p>
            <a href="<?= URLROOT . 'themes' ?>" class="inline-block mt-4 px-6 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 transition">Explore Articles</a>
        </div>
    <?php else: ?>
